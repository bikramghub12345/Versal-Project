...
# --- Plot 1: Accuracy vs Bits (with baseline) ---
...
if os.path.exists(acc_path):
    ...
    # Build x-axis: prepend k=0 (baseline) then fault bits
    ...
    bars = ax.bar(x_labels, y_vals, color=colors, edgecolor='black', width=0.5)
