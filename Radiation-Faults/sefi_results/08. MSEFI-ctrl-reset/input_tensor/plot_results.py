#!/usr/bin/env python3
# SEFI Simulation Plots — mode: MSEFI-ctrl-reset, target: input_tensor
...
res_rows = read_csv(os.path.join(OUTDIR, 'results_MSEFI-ctrl-reset.csv'))
