#!/usr/bin/env python3
# SEFI Simulation Plots — mode: transient-SEFI-col, target: input_tensor
...
res_rows = read_csv(os.path.join(OUTDIR, 'results_transient-SEFI-col.csv'))
