#!/usr/bin/env python3
# SEFI Simulation Plots — mode: transient-SEFI-blk, target: input_tensor
...
res_rows = read_csv(os.path.join(OUTDIR, 'results_transient-SEFI-blk.csv'))
